...
class SiteController extends Controller
{
    ...
    public function handleServiceRequest(Request $request) {
        ...
        $serviceRequest = new Order(['style_description' => $request->input('style_description'),
            'style_file' => $filename,
            'fabric_source' => $request->input('fabric_source', 'n/a'),
            'measurement_source' => $request->input('measurement_source','n/a'),
            'email' => $request->input('email'),
            'name' => $request->input('name'), 'phone' => $request->input('name'),
            'address' => $request->input('address'),
            'reference' => $reference,
            'payment_status' => 'paid',
            'measurement_shoulder_back' => $request->input('measurement_shoulder_back','n/a'),
            'measurement_chest' => $request->input('measurement_chest','n/a'),
            'measurement_top_length' => $request->input('measurement_top_length','n/a'),
            'measurement_neck' => $request->input('measurement_neck','n/a'),
            'measurement_body_stomach' => $request->input('measurement_body_stomach','n/a'),
            'measurement_sleeves' => $request->input('measurement_sleeves','n/a'),
            'measurement_round_sleeves' => $request->input('measurement_round_sleeves','n/a'),
            ]);
        $serviceRequest->save();
        try {
